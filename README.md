...
ShowUI is a lightweight vision-language-action model for GUI agents. You can easily run ShowUI on [Windows](#usage) and [macOS](#macOS)! For macOS users, please set the torch device to "mps".
